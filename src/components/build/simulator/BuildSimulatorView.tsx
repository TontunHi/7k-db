        ...
        try {
            ...
            if (mode === 'download') {
                ...
                if (typeof ClipboardItem !== 'undefined') {
                    try {
                        // Use Promise-based ClipboardItem to maintain user gesture context better
                        const blobPromise = toBlob(exportRef.current, options).then(b => {
                        ...
                        // Ensure window is focused before writing to clipboard
                        ...
                        if (clipboardErr.name === 'NotAllowedError') {
                            toast.error("Failed to copy: Document is not focused. Please keep the tab active.", { id: loadToast })
                        } else {
                            toast.error("Failed to copy. Please try again or use Download.", { id: loadToast })
                        }
                    }
                } else {
