                            ...
                            {TYPES.map(type => (
                                <th key={type} className="p-4 bg-gray-900 border-b border-gray-800 text-center border-l border-gray-800">
                                    <div className="relative h-8 w-24 mx-auto">
                                        <SafeImage src={`/logo_tiers/type/${type.toLowerCase()}.webp`} fill className="object-contain" alt={type} sizes="96px" />
                                    </div>
                                </th>
                            ))}
                        </tr>
                            ...
                            <tr key={rank} className="border-b border-gray-800/50 hover:bg-gray-900/20">
                                <th className="p-4 bg-gray-900/50 border-r border-gray-800 font-bold text-gray-300 text-center">
                                    <div className="relative h-12 w-12 mx-auto">
                                        <SafeImage src={`/logo_tiers/rank_tier/${rank}.webp`} fill className="object-contain" alt={rank} sizes="48px" />
                                    </div>
                                </th>
                                {TYPES.map(type => {
                                                ...
                                                {cellHeroes.map(entry => (
                                                    ...
                                                    >
                                                        <div className="w-full h-full rounded overflow-hidden">
                                                            <SafeImage src={`/heroes/${entry.heroFilename}`} fill className="object-cover" alt="hero" sizes="48px" />
                                                        </div>
                ...
                <div className="flex flex-wrap gap-3">
                    {poolHeroes.map(hero => (
                        <div
                            ...
                            title={hero.name}
                        >
                            <SafeImage src={`/heroes/${hero.filename}`} fill className="object-cover" alt={hero.name} sizes="56px" />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {RANKS.map(r => (
                                        ...
                                        >
                                            <SafeImage src={`/logo_tiers/rank_tier/${r}.webp`} fill className="object-contain p-2" alt={r} sizes="64px" />
                                        </button>
                                    ))}
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {TYPES.map(t => (
                                        <button
                                            ...
                                            className="bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-[#FFD700] p-3 rounded-lg flex items-center justify-center transition-all h-16 relative"
                                        >
                                            <SafeImage src={`/logo_tiers/type/${t.toLowerCase()}.webp`} fill className="object-contain p-2" alt={t} sizes="64px" />
                                        </button>
                                    ))}
                                </div>
                            </div>
