        ...
        <div className="container mx-auto px-4 py-20 max-w-4xl font-sans tracking-tight leading-relaxed">
            <div className="text-center mb-20 relative">
                ...
                <h1 className="text-5xl md:text-7xl font-black text-foreground italic transform -skew-x-12 uppercase mb-6 drop-shadow-lg leading-tight">
                    {lang === 'th' ? "เกี่ยวกับ " : "ABOUT "}<span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-amber-500">7K DB</span>
                </h1>
            ...
            <div className="space-y-12">
                <section className="relative p-8 md:p-12 rounded-3xl bg-surface border border-border shadow-xl overflow-hidden group">
                    ...
                    <div className="absolute -left-8 top-4 text-7xl font-black text-foreground/5 select-none transform -skew-x-12 uppercase tracking-tighter hidden md:block">{t("about.vision_title", "Vision")}</div>
                    <div className="relative z-10">
                        <h2 className="text-2xl font-black text-foreground uppercase tracking-widest mb-6 flex items-center gap-4">
                            <span className="w-8 h-px bg-primary"></span>
                            {t("about.vision_title", "The Vision")}
                        </h2>
                        <p className="text-lg text-muted-foreground font-light leading-relaxed">
                            {t("about.vision_desc", "7K DB is the most comprehensive and up-to-date resource dedicated to Seven Knights Rebirth. Our vision is to provide players with the ultimate tools, precise hero builds, and expert strategies to master every aspect of the game.")}
                        </p>
                    </div>
                </section>
                ...
                <section className="relative p-8 md:p-12 rounded-3xl bg-surface border border-border shadow-xl overflow-hidden group">
                    ...
                    <div className="relative z-10 text-center max-w-2xl mx-auto">
                        <h2 className="text-2xl font-black text-foreground uppercase tracking-widest mb-6 flex items-center justify-center gap-4">
                            ...
                            {t("about.community_title", "Community Made")}
                            <span className="w-8 h-px bg-amber-500"></span>
                        </h2>
                        <p className="text-lg text-muted-foreground font-light mb-6 leading-relaxed">
                            {t("about.community_desc", "This project is built for the community, by the community. We are passionate about the Seven Knights franchise and want to ensure every player has the tools they need to succeed in PVP and PVE modes.")}
                        </p>
                    </div>
                </section>
                ...
                <section className="pt-10 text-center">
                    <p className="text-muted-foreground/60 text-sm uppercase tracking-[0.2em] font-bold italic">
                        {t("about.footer", "Built with cutting-edge tech for the best experience.")}
                    </p>
                </section>
            </div>
        </div>
