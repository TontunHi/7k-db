                    ...
                    <div className={clsx("md:col-span-2", styles.editActions)}>
                        <button 
                            onClick={() => onUpdate(item.id, {
                                platform: (document.getElementById(`plat-${item.id}`) as HTMLSelectElement).value,
                                name: (document.getElementById(`name-${item.id}`) as HTMLInputElement).value,
                                link: (document.getElementById(`link-${item.id}`) as HTMLInputElement).value
                            })}
