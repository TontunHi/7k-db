...
/**
 * TotalWarSkillPicker - Modal for selecting hero skills in rotation
 */
export default function TotalWarSkillPicker({ 
    setIdx, 
    teamIdx,
    slotIdx, 
    teamHeroes, 
    ...
    if (setIdx === undefined || setIdx === null || teamIdx === undefined || teamIdx === null) return null
        ...
        <div className={styles.modalOverlay} onClick={onClose}>
            <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
                <header className={styles.modalHeader}>
                    <div>
                        <h3 className="text-xl font-black text-white italic transform -skew-x-6">Tactical Directive</h3>
                        <p className="text-[10px] font-black uppercase tracking-widest text-red-500">SELECT SKILL FOR TEAM {teamIdx + 1} / SLOT {slotIdx + 1}</p>
                    </div>
                ...
                <div className={styles.modalBody}>
                    ...
                    {!teamHeroes.some(h => h) && (
                        <div className="text-center py-10">
                            <p className="text-sm italic text-muted-foreground font-bold">Squad incomplete. Assign heroes to the team first.</p>
                        </div>
                    )}
                </div>
            </div>
