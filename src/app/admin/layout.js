    ...
    const navSections = [
        {
            title: "General",
            items: [
                { name: "Manage Builds", href: "/admin/builds", icon: FileImage, color: "text-blue-500" },
                { name: "Manage Tierlist", href: "/admin/tierlist", icon: TrendingUp, color: "text-pink-500" },
            ]
        },
        {
            title: "PVE Content",
            items: [
                { name: "Manage Stages", href: "/admin/stages", icon: Map, color: "text-amber-500" },
                { name: "Dungeons", href: "/admin/dungeon", icon: Landmark, color: "text-emerald-500" },
                { name: "Raids", href: "/admin/raid", icon: Skull, color: "text-red-500" },
                { name: "Castle Rush", href: "/admin/castle-rush", icon: Crown, color: "text-yellow-500" },
                { name: "Advent Expedition", href: "/admin/advent", icon: Compass, color: "text-violet-500" },
            ]
        },
        {
            title: "PVP Content",
            items: [
                { name: "Arena Teams", href: "/admin/arena", icon: Crosshair, color: "text-orange-500" },
                { name: "Total War", href: "/admin/total-war", icon: Swords, color: "text-rose-500" },
                { name: "Guild War Teams", href: "/admin/guild-war", icon: Shield, color: "text-indigo-500" },
            ]
        },
        {
            title: "Others",
            items: [
                { name: "Asset Manager", href: "/admin/assets", icon: Settings, color: "text-gray-500" },
            ]
        }
    ]
