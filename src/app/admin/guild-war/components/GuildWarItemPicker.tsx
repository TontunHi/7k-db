        ...
        <div className={styles.modalOverlay} onClick={onClose}>
            <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
                <header className={styles.modalHeader}>
                    <div>
                        <h3 className="text-xl font-black text-foreground capitalize">Tactical {type} Registry</h3>
                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 gap-4">
                        ...
                        {items.map(item => (
                            <button
                                ...
                                className="group aspect-square rounded-2xl border border-border bg-muted hover:border-amber-500/50 hover:shadow-[0_0_20px_rgba(245,158,11,0.15)] transition-all p-3 flex items-center justify-center relative overflow-hidden"
                            >
