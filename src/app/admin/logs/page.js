...
import { History, Search, Filter, ArrowLeft, ArrowRight, User, Tag, Clock, ExternalLink } from "lucide-react"
            ...
            <div className="bg-[#0a0a0a] border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl relative">
                ...
                {logs.length === 0 && (
                    <div className="py-20 text-center space-y-4">
                        <History className="w-12 h-12 text-gray-800 mx-auto" />
                        <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">No records found for this category</p>
                    </div>
                )}
