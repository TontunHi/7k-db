...
export const DASHBOARD_CATEGORIES = [
    ...
    },
    {
        ...
        items: [
            { title: "User Management", desc: "Manage administrative accounts.", href: "/admin/users", marker: "bg-cyan-500", perm: "MANAGE_USERS", superOnly: true },
            { title: "Site Settings", desc: "Global system configuration.", href: "/admin/settings", marker: "bg-gray-500", perm: "MANAGE_SETTINGS" },
            { title: "Audit Logs", desc: "System interaction history.", href: "/admin/logs", marker: "bg-orange-500", perm: "MANAGE_LOGS" },
        ]
    }
]
