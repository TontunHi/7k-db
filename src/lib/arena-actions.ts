...
import { validateData, ArenaTeamSchema, type ArenaTeam as ArenaTeamInput } from './validation'
...
export async function createArenaTeam(data: ArenaTeamInput): Promise<ActionResponse> {
    await requireAdmin()
...
export async function updateArenaTeam(id: number, data: ArenaTeamInput): Promise<ActionResponse> {
    await requireAdmin()
...
export async function deleteArenaTeam(id: number): Promise<ActionResponse> {
    await requireAdmin()
    try {
...
export async function reorderArenaTeams(orderedIds: number[]): Promise<ActionResponse> {
    await requireAdmin()
    try {
